...
---Bir bölge oluşturur veya günceller
...
---Bir bölgeyi siler
---@param args table Silinecek bölge bilgileri
...
---@param args table Spawner bilgileri
...
---Bir spawner'ın adını değiştirir
---@param args table Spawner bilgileri
...
---Bir spawner'ı siler
---@param args table Silinecek spawner bilgileri
...
---@param args table Yapılandırma bilgileri
...
---Yeni bir temizleyici bölgesi ekler
---@param args table Temizleyici bölgesi bilgileri
...
---Bir temizleyici bölgesini düzenler
---@param args table Temizleyici bölgesi bilgileri
...
---@param args table Silinecek temizleyici bölgesi bilgileri
