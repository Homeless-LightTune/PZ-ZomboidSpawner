...
---Zombilerin spawn edilip edilmeyeceğini kontrol eder
...
---Spawn konumunun geçerli olup olmadığını kontrol eder
---@param x number X koordinatı
---@param y number Y koordinatı
---@param z number Z koordinatı
---@param zone table Bölge bilgileri
---@return boolean
...
---@param zoneData table Bölge bilgileri
...
---Tüm bölgelerde zombi spawn eder
