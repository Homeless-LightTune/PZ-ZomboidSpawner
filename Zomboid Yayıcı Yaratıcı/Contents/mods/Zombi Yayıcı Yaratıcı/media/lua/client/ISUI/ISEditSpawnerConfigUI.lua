...
function ISEditSpawnerConfigUI:createChildren()
    ...
    -- Spawn Aralığı
    self.spawnIntervalLbl = ISLabel:new(10, y, 10, "Doğum Aralığı", 1, 1, 1, 1, UIFont.Medium, true);
    ...
    self.zombiesNbr.tooltip = "Her doğumda oluşacak zombi sayısı (her spawner için)"
    ...
    "Bölgenin doğumu durduracağı maksimum zombi sayısı. Sonsuz için -1 olarak ayarlayın (her spawner için)"
...
function ISEditSpawnerConfigUI:onClick(button)
    ...
    elseif button.internal == "EDIT" then
        ...
        local text =
        "Spawner ayarlarını düzenlemek istediğinizden emin misiniz? Bu işlem tüm manuel spawner'lara uygulanacaktır!"
