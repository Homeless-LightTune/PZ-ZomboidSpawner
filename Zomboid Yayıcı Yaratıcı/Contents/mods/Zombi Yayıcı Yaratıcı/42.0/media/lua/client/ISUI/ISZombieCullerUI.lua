...
function ISZombieCullerUI:createChildren()
    ...
    -- Tüm bölgeleri göstermek için liste
    ...
    self.teleportBtn.tooltip = "<GREEN> Seçilen bölgeye ışınlan"
...
function ISZombieCullerUI:prerender()
    ...
    self:drawText("Zombi Sınırlayıcı",
        self.width / 2 - (getTextManager():MeasureStringX(UIFont.Title, "Zombi Sınırlayıcı") / 2), 20, 1, 1, 1, 1,
        UIFont.Title)
    ...
    if not self.selectedZone then
        ...
        self.teleportBtn.tooltip = "<RED> Hiçbir bölge seçilmedi"
        self.editBtn.tooltip = "<RED> Hiçbir bölge seçilmedi"
        self.deleteBtn.tooltip = "<RED> Hiçbir bölge seçilmedi"
    else
        ...
        self.teleportBtn.tooltip = "<GREEN> Seçilen bölgeye ışınlan"
        self.editBtn.tooltip = "<GREEN> Seçilen bölgeyi düzenle"
        self.deleteBtn.tooltip = "<RED> Seçilen bölgeyi sil"
    end
end
