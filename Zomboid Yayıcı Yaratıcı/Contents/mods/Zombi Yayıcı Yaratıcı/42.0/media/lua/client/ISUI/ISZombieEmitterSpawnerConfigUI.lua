...
function ISZombieEmitterSpawnerConfigUI:prerender()
    ...
    if not self.selectedSpawner then
        ...
        self.teleportBtn.tooltip = "<RED> Hiçbir spawner seçili değil"
        self.renameBtn.tooltip = "<RED> Hiçbir spawner seçili değil"
        self.deleteBtn.tooltip = "<RED> Hiçbir spawner seçili değil"
    else
