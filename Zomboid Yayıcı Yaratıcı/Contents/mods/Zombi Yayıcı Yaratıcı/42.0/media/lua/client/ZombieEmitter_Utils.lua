...
---Bir culler bölgesinin var olup olmadığını kontrol eder
---@param name string Kontrol edilecek bölgenin adı
---@return boolean Bölge varsa true, yoksa false
...
---@param text string Gösterilecek metin
...
function ZombieEmitterUtils.startFire(square)
    ...
    -- Ateş animasyonunu ekle (kamp ateşine benzer parametreler kullanarak)
    ...
    -- Ateş nesnesinin ateş yöneticisi tarafından düzgün bir şekilde güncellenmesini sağla
...
---Tüm mevcut culler bölgelerini döndürür
---@return table
